  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-20 sm:py-32 text-center relative">
          ...
          <p className="mt-4 sm:mt-6 text-base sm:text-lg md:text-xl text-white/50 max-w-2xl mx-auto leading-relaxed px-2">
          ...
          <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
            <Link href="/download" className="w-full sm:w-auto bg-[#00E5FF] text-[#050B14] font-bold px-8 py-3.5 rounded-lg hover:opacity-90 transition-opacity text-base text-center">
              Download for Free
            </Link>
            <Link href="https://discord.gg/zcgMzRwJFv" target="_blank" className="w-full sm:w-auto border border-white/20 text-white/80 font-medium px-8 py-3.5 rounded-lg hover:bg-white/5 transition-colors text-base text-center">
              Join Discord
            </Link>
          </div>
          <p className="mt-4 text-white/20 text-xs sm:text-sm">Windows 10/11 &middot; Overwolf Required &middot; 100% Free</p>
        </div>
      </section>

      {/* Features */}
      <section id="features" className="max-w-6xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center mb-3 sm:mb-4">Everything you need to improve.</h2>
        <p className="text-center text-white/40 mb-10 sm:mb-16 max-w-xl mx-auto text-sm sm:text-base">Built by a player, for players. No bloat, no subscriptions, no data harvesting.</p>
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
        <div className="glass-card text-center py-8 sm:py-12 border-[#00E5FF]/20">
          <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-3 sm:mb-4 px-2">Your data stays on your machine.</h2>
          <p className="text-white/40 max-w-xl mx-auto leading-relaxed text-sm sm:text-base px-2">
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 py-16 sm:py-24 text-center">
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 sm:mb-4">Ready to track your games?</h2>
        <p className="text-white/40 mb-6 sm:mb-8 text-sm sm:text-base">Download ApexPulse and start improving today.</p>
        <Link href="/download" className="bg-[#00E5FF] text-[#050B14] font-bold px-8 sm:px-10 py-3.5 sm:py-4 rounded-lg hover:opacity-90 transition-opacity text-base sm:text-lg">
          Download for Free
        </Link>
      </section>
    </>
